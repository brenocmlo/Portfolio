  ...
  return (
    <section id="projetos" className="py-24 relative overflow-hidden bg-bg-darker/40">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* Projects Grid using MagicBento */}
        <MagicBento 
          ...
          // Remove global glowColor since cards have individual ones
          renderCardContent={(project: any) => (
            <div className={`flex flex-col h-full bg-[#111827]/40 rounded-3xl glass-panel border-white/5 transition-all duration-300 ${project.color.replace('hover:', '')}`}>
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                {/* Title */}
                <h3 className="font-display font-bold text-2xl text-white mb-4 transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tags.map((tag: string) => (
                    <span
                      key={tag}
                      className="px-3 py-1 rounded-lg text-xs font-semibold text-slate-300 bg-white/5 border border-white/5 transition-colors"
                    >
                      {tag}
                    </span>
                  ))}
